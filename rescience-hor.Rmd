...
in digitial format, but the images [@Wassle1978-cd; @Wassle2000-aa]
...
2. sjedist: unified calculation of spatial stastitics.
   <https://github.com/sje30/sjedist>
3. sjevor: Wrapper around public domain code for Voronoi tesselation
   <https://github.com/sje30/sjevor>
   
The Voronoi tesselation was public domain C code provided by Steve
Fortune [@Fortune1987-kg].  (This cdoe was not required for the current
...
harddrive.  One complication was that until a few years ago, I had
...
I anticipated that retrieving teh data might be tricky, as I had used
...
(ThinkPad T480s running Manjaro linux) and on <mybinder.org> (see the
end of this document for mybinder details.)

However, althoughthe code worked fine, it took me a few minutes to
...
mybinder.org by following the instructions at the project home page,
<http://github.com/sje30/rescience-hor>.
